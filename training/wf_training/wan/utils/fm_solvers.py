...
class FlowDPMSolverMultistepScheduler(SchedulerMixin, ConfigMixin):
    ...
    def begin_index(self):
        """
        The index for the first timestep. It should be set from wf_training.pipeline with `set_begin_index` method.
        """
    ...
    def set_begin_index(self, begin_index: int = 0):
        """
        Sets the begin index for the scheduler. This function should be run from wf_training.pipeline before the inference.
        Args:
            begin_index (`int`):
