...
from wf_training.assets import model_directory

from wf_training.utils.scheduler import SchedulerInterface, FlowMatchScheduler
from wf_training.wan.modules.tokenizers import HuggingfaceTokenizer
from wf_training.wan.modules.model import WanModel, RegisterTokens, GanAttentionBlock
from wf_training.wan.modules.vae import _video_vae
from wf_training.wan.modules.t5 import umt5_xxl
from wf_training.wan.modules.causal_model import CausalWanModel
...
class WanVAEWrapper(torch.nn.Module):
    def __init__(self, model_name="Wan2.1-T2V-1.3B"):
        ...
        self.model = _video_vae(
            pretrained_path=str(Path(model_directory(self.model_name)) / "Wan2.1_VAE.pth"),
            z_dim=16,
        ).eval().requires_grad_(False)
...
class WanDiffusionWrapper(torch.nn.Module):
    def __init__(
        ...
        if not load_pretrained:
            ...
            self.model = WanModel.from_pretrained(model_directory(model_name))
        self.model.eval()
